...
const Header = (props) => {
    ...
    useEffect(() => {
        ...
        const headerRoutes = document.querySelector('.header-routes')
        const toggleMobile = () => {
            headerRoutes.classList.toggle('mobile')
        }
        headerBars.addEventListener('click', toggleMobile)

        return () => {
            headerBars.removeEventListener('click', toggleMobile)
        }
    }, [])

    useEffect(() => {
        const headerIconDown = document.querySelector('.header-route-icon')
        const openSub = () => {
            const headerSub = document.querySelector('.header-route-sub')
        ...
        headerIconDown.addEventListener('click', openSub)

        return () => {
            headerIconDown.removeEventListener('click', openSub)
        }
    }, [])
