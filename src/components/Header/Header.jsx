        ...
        <header ref={headerRef}>
            <div className='header'>
                ...
                <ul className="header-routes">
                    ...
                    <li><a href='/' className='header-route'>Features</a></li>
                    <li><a href='/' className='header-route'>Overview</a></li>
                    <li><a href='/' className='header-route'>Pricing</a></li>
                    <li><a href='/' className='header-route'>Team</a></li>
                    <li>
                        <a href='/' className='header-route'>Blog</a>
